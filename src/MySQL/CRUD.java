...
public class CRUD {
    ...
    public static void archiveItem(Connection con, String itemName) throws SQLException{
        Statement stmt;
        stmt = con.createStatement();
        stmt.executeUpdate("UPDATE `item` SET `removed` = 1 WHERE `item`.`item_name`='"+itemName+"' ");
    }
    //END OF ITEM RELATED
